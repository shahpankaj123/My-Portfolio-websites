...
$(document).ready(function() {
    ...
    $('#contactForm').on('submit', function(e) {
        ...
        submitBtn.html('<span>Sending...</span><i class="fas fa-spinner fa-spin"></i>');
    ...
    console.log('%cLooking for a talented Full-Stack Engineer?', 'font-size: 14px; color: #8b5cf6;');
    console.log('%cLet\'s work together! Contact me at pshah9360@gmail.com', 'font-size: 14px; color: #ec4899;');
